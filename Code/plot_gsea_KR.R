...
gsea_files = list.files(pattern = "*_KR_GSEA_Results.txt")
gsea_files_concise = list.files(pattern = "*_KR_GSEA_Concise_Results.txt")
...
png("Case_Case_vs_xDx_KR.png", res = 300, width = 15, height = 12, units = "in")
...
png("Case_Case_vs_Case_Control_KR.png", res = 300, width = 15, height = 12, units = "in")
